 ...
 *
 */
 int obtenerStringAlfanumerico(char mensaje[],char entrada[])
 {
     char aux[256];
 ...
 *
 */
 void obtenerStringValidoLetras(char solicitarMensaje[], char errorMensaje[], char entrada[])
 {
     while(1)
     {
 ...
 *
 */
 void obtenerStringValidoAlfanumerico(char solicitarMensaje[], char errorMensaje[], char entrada[])
 {
     while(1)
     {
         if(!obtenerStringAlfanumerico(solicitarMensaje,entrada))
         {
            printf("%s\n",errorMensaje);
            continue;
         }
